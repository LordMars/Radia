              ...
              children: <Widget>[
                ...
                new Expanded(
                  child: new TextFormField(
                    ...
                    decoration: new InputDecoration(
                        hintText: '4', border: new OutlineInputBorder()),
                    keyboardType: TextInputType.number,
                    validator: (val) => (val.length != 1 ||
                            int.parse(val.substring(0, 1),
                                    onError: (e) => null) ==
